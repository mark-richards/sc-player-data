...
from website.data.loader import load_sc_current, load_fanfooty_season
...
def draft_heat_map():
    ...
    fanfooty_df = load_fanfooty_season()
    summary, board, n_rounds, coaches = load_draft_board(
        DRAFT_CSV_2026, PLAYER_LIST_CSV_2026, DRAFT_ALIAS_MAP, COACH_ORDER, sc_df, fanfooty_df
    )
